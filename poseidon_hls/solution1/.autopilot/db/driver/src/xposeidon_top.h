...
// 
// ==============================================================
#ifndef XPOSEIDON_TOP_H
#define XPOSEIDON_TOP_H
...
#ifndef __linux__
#define XPoseidon_top_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XPoseidon_top_ReadReg(BaseAddress, RegOffset) \
...
#else
int XPoseidon_top_Initialize(XPoseidon_top *InstancePtr, const char* InstanceName);
int XPoseidon_top_Release(XPoseidon_top *InstancePtr);
#endif
