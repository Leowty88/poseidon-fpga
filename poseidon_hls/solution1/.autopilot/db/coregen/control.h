...
#define CONTROL_ADDR_ROUND_CONSTANTS_DATA 0x10
#define CONTROL_BITS_ROUND_CONSTANTS_DATA 64
#define CONTROL_ADDR_MDS_MATRIX_DATA      0x1c
#define CONTROL_BITS_MDS_MATRIX_DATA      64
